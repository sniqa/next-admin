export const ARGMENTS_ERROR = '参数错误'
export const IP_V4_FORMAT_ERROR = 'IP_V4_FORMAT_ERROR'
...
export enum REPEAT {
	SERIAL_NUMBER_IS_REPEAT = '资产编号重复',
	DEVICE_MODEL_IS_REPEAT = '设备型号重复',
	DEVICE_STATUS_IS_REPEAT = '设备状态重复',
	NETWORK_IS_REPEAT = '网络重复',
	USERNAME_IS_REPEAT = '用户名称重复',
}
